...
const MoveableNav = () => {
  ...
  return (
    <>
      ...
      >
        <Image src={`/Assets/3d/nav.png`} alt="" priority="true" width={30} height={30} />
      </div>
      <div className={styles.moveableNav}>
        ...
        >
          <Link href="/projects">
            <a onClick={() => setShow(false)}>
              <Image src="/Assets/3d/projects.png" alt="" priority="true" width={30} height={30} />
            </a>
          </Link>
        </div>
        <div
        ...
        >
          <Link href="/articles">
            <a onClick={() => setShow(false)}>
              <Image src="/Assets/3d/articles.png" alt="" priority="true" width={30} height={30} />
            </a>
          </Link>
        </div>
        <div
        ...
        >
          <Link href="/about">
            <a onClick={() => setShow(false)}>
              <Image src="/Assets/3d/about.png" alt="" priority="true" width={30} height={30} />
            </a>
          </Link>
        </div>
        <div
        ...
        >
          <Link href="/">
            <a onClick={() => setShow(false)}>
              <Image src="/Assets/3d/hash.png" alt="" priority="true" width={30} height={30} />
            </a>
          </Link>
        </div>
      </div>
