    ...
    <>
      <div className={styles.about}>
        ...
        <div className={styles.contact}>
          Mail Us at :{" "}
          <Link href="mailto:legrosh2021@gmail.com">
            <a>legrosh2021@gmail</a>
          </Link>
        </div>
          ...
          <ul>
            ...
            <li>
              ...
              <Link href="https://forms.gle/cxo8s44xseoEDAFi6">
                <a className={styles.call}>book a call</a>
              </Link>{" "}
              with us where we can discuss whatever you want and we will try and
              help you as much as we can or you can just share whatever you want
              and feel lighter
            </li>
            <li>
        ...
        <div className={styles.abtMe}>
          ...
          <span>
            ...
            mine but the most beautiful one. I like to play guitar and I am an
            Tech and StartUp Entusiast, an Enterprenuer myself and My Final goal
            is to became an angle investor, support and be the part of all those
            wonders that will happen that I cant do alone. I want to add value
            to the community as much as I can, be it with my work or by money!{" "}
            <br />
            Reach me out on <br />
            <div>
              <Link href="https://www.youtube.com/channel/UCJN78Ra_w_0Vj5MqLBvsxMA">
                <a>
                  <IoLogoYoutube className="text-red-600 mx-5 text-3xl" />
                </a>
              </Link>
              <Link href="https://www.linkedin.com/in/harsh-jaiswani-26108823b/">
                <a>
                  <IoLogoLinkedin className="text-indigo-500 mx-5 text-3xl" />
                </a>
              </Link>
            </div>
          </span>
                ...
                <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
                  ...
                  <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                    <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                      ...
                      <p className="leading-relaxed mx-1">Class 10th - 89%</p>
                    </div>
                  </div>
                </div>
                <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
                  ...
                  <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                    <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                      ...
                      <p className="leading-relaxed mx-1">Class 12th - 77%</p>
                    </div>
                  </div>
                </div>
                <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
                  ...
                  <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                    <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                      <h2 className="font-medium title-font text-gray-200 mb-1 text-xl">
                        Shri Shankaracharya Institute of Professtional
                        Management and Technology
                      </h2>
                      <p className="leading-relaxed bg-[#112240] rounded-xl px-2 text-gray-500 w-fit">
                        November 2022 - Present
                      </p>
                      <p className="leading-relaxed mx-1">BTech In CS</p>
                    </div>
                  </div>
                </div>
                <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
                  ...
                  <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                    <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                      ...
                      <p className="leading-relaxed mx-1">Company</p>
                    </div>
                  </div>
                </div>
              </div>
